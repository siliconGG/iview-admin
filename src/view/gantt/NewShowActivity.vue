  ...
  export default {
    ...
    methods: {
      ...
      fetchData () {
        ...
        if (actId) {
          instance.get( that.GLOBAL.serverPath + "/activity/getTreeData?actId=" + actId).then(res => {
            if (res.data.success) {
          ...
          instance.get( that.GLOBAL.serverPath + "/activity/getActivityById?actId=" + actId).then(res => {
            if (res.data.success) {
